                   ...
                   <div className="card-body">
                       <form onSubmit={this.onSubmit}>
                           ...
                           <div className="form-group">
                               ...
                               <input type="email" className="form-control" name="email" minLength="2" required onChange={this.onChange} value={this.state.email} />
                           </div>

                           <div className="form-group">
                               <label htmlFor="phone">Phone</label>
                               <input type="text" className="form-control" name="phone" minLength="2" required onChange={this.onChange} value={this.state.phone} />
                           </div>

                           <div className="form-group">
                               <label htmlFor="balance">Balance</label>
                               <input disabled={disableBalanceOnAdd} type="text" className="form-control" name="balance" required onChange={this.onChange} value={this.state.balance} />
                           </div>
